...
image::https://github.com/thapamanish/ai-doc-assistant/actions/workflows/python-tests.yml/badge.svg[Build Status, link="https://github.com/<your-github-username>/<your-repo-name>/actions/workflows/ci.yml"]
